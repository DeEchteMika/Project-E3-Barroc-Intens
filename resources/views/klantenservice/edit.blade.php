...
<div class="max-w-3xl mx-auto mt-10">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h1 class="text-2xl font-semibold mb-6">Klant bewerken</h1>

        <form action="{{ route('klantenservice.update', $klant->klant_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    {{-- show from database, no input --}}
                    <input type="text" name="bkr_check" id="bkr_check" value="{{ $klant->bkr_check }}" class="w-full border rounded py-2 px-3 text-gray-700 bg-gray-100 cursor-not-allowed" readonly>
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <a href="{{ route('klanten') }}" class="text-sm text-gray-600 hover:underline">Annuleren</a>
            </div>
        </form>
    </div>
</div>
